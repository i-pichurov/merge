...
Ставим Poetry (это инструмент для управления зависимосятми, публикации и установки пакетов Python) с помощью команды:
...
Устанавливаем созданный пакет в изолированное виртуальной окружение, сохраняя при этом доступ самого скрипта к файлам нашей системы, с помощью pipx:
...
Пример применения:
    ...
    # В файл 'test_result.txt' будет сохранен результат слияния файлов: test1.txt test2.txt test3.txt
